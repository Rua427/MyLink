...
### 3. 메인 랜딩 페이지 (서비스 홈)
서비스를 처음 접하는 방문자를 위한 소개 및 가입 유도 랜딩 페이지입니다.
...
|       [ Hero Section ]                                                                  |
|       나만의 모든 링크를                                   +-----------------------+    |
|       하나의 페이지로 모아보세요.                          |      @your_name       |    |
|                                                            |  +-----------------+  |    |
|       MyLink를 통해 인스타그램, 깃허브, 블로그 등          |  | 🐙 GitHub       |  |    |
|       다양한 채널을 쉽고 빠르게 공유할 수 있습니다.        |  +-----------------+  |    |
|                                                            |  +-----------------+  |    |
|       +-----------------------------------+                |  | ✍️ Blog         |  |    |
|       |    [G] Google 계정으로 3초만에 가입 |                |  +-----------------+  |    |
|       +-----------------------------------+                +-----------------------+    |
|                                                                                         |
|-----------------------------------------------------------------------------------------|
|                                                                                         |
|       [ Features Section ]                                                              |
|                                                                                         |
|       ✨ 직관적인 인라인 편집               📊 클릭 통계 분석                           |
|       번거로운 관리자 대시보드 없이         어떤 링크가 가장 인기가 많은지              |
|       화면에서 바로 클릭해 수정하세요.      누적 클릭 수를 통해 확인하세요.             |
|                                                                                         |
+-----------------------------------------------------------------------------------------+
```
- **특징 1:** 첫 화면(Hero)에서 서비스의 목적을 직관적으로 알 수 있는 예시(목업) 화면을 우측에 배치합니다.
- **특징 2:** 가입 장벽을 낮추기 위해 가장 잘 보이는 곳에 구글 소셜 로그인 버튼을 배치합니다.
- **특징 3:** 스크롤 시 하단(Features)에 마이링크만의 핵심 강점(인라인 편집, 통계 기능)을 어필합니다.
